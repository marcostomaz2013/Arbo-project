...
(function($) {
    'use strict';
    $(function() {
        var elemento = $('table[tbody-fixed="true"]');
        ...
        if (elemento.length > 0) {
            ...
            var tbody = $('table[tbody-fixed="true"] tbody').height();
            if (tbody < scrollY) {
                scrollY = "";
                scrollX = "";
            }
        }  
        $('#datatablepadrao').DataTable({
            "oLanguage": {
...
$(document).ready(function() {
    ...
    var elemento = $('table[remove-filter-double="true"]');
    console.log("******************");
    console.log($(elemento));
    if (elemento.length > 0) {
        $('.dataTables_scrollBody table[tbody-fixed="true"] thead').hide();
    }
} );
